...
=========================================================== */
(function () {
  const SELECTOR = ".btn, .menu-tab, .pick-chip, .pizza-card, .faq-item summary, .mobile-nav a, .qty button, .btn-sm, .close-mn, .menu-toggle, .ar-launch-btn, .sticky-cart-summary, [data-qty-btn], .ios-switch, .btn-add-overlay, .badge-ar";
