...
=========================================================== */
(function () {
  const SELECTOR = ".btn, .menu-tab, .pick-chip, .pizza-card, .faq-item summary, .mobile-nav a, .btn-sm, .close-mn, .menu-toggle, .ar-launch-btn, .ios-switch, .size-chip, .dough-swatch-btn, .badge-ar";
